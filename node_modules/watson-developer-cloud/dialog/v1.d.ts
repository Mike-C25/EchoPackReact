...
declare class DialogV1 extends BaseService {
     ...
     */
    getProfile(params: DialogV1.GetProfileParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Sets the values for profile variables
     * @param  {Object}   params   { client_id: '', dialog_id: '', name_values:''}
     */
    updateProfile(params: DialogV1.UpdateProfileParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Returns a chat session data dump for a given date.
     * @param  {Object}   params   { client_id: '', dialog_id: '', name_values:''}
     */
    getConversation(params: DialogV1.GetConversationParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     ...
     */
    conversation(params: DialogV1.ConversationParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Updates content for specified nodes.
     * @param  {Object}   params   { dialog_id: '' }
     */
    updateContent(params: DialogV1.UpdateContentParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Gets content for nodes.
     * @param  {Object}   params   { dialog_id: '' }
     */
    getContent(params: DialogV1.GetContentParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Create a dialog based on a file and name
     * @param  {Object}   params   { name: '', file:'' }
     */
    createDialog(params: DialogV1.CreateDialogParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Returns the dialogs associated with a service instance
     */
    getDialogs(params: DialogV1.GetDialogsParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Delete a dialog and removes all associated data
     */
    deleteDialog(params: DialogV1.DeleteDialogParams, callback: DialogV1.Callback): ReadableStream | void;
    /**
     * Update a dialog with a new dialog file
     * @param  {Object}   params   { dialog_id: '' }
     */
    updateDialog(params: DialogV1.UpdateDialogParams, callback: DialogV1.Callback): ReadableStream | void;
}
